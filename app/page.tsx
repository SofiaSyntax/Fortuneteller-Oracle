...
export default function Home() {
  ...
  const askFortune = async () => {
    ...
    try {
      ...
      console.error(err);
      setFortune("Oops, something went wrong in the spiritual connection.");
    }
  ...
  return (
    <main className="relative min-h-screen flex flex-col items-center justify-center px-4 bg-gradient-to-b from-indigo-900 via-purple-900 to-black text-white font-serif overflow-hidden">
      ...
      >
        {loading ? "Consulting the spirits..." : "Show Fortune"}
      </button>
      ...
      <button
        ...
        aria-label={isPlaying ? "Turn off music" : "Play mystical music"}
        title={isPlaying ? "Turn off music" : "Play mystical music"}
      >
        <Music
          size={28}
